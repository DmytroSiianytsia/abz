      ...
      <div className="container">
        <div className="header__content">
          ...
          <nav className="nav-header">
            <ul className="nav">
              <li className="nav__item" tabIndex="0" onClick={() => scrollTo('main')}>Main</li>
              <li className="nav__item" tabIndex="1" onClick={() => scrollTo('aboutMe')}>About me </li>
              <li className="nav__item" tabIndex="2">Requirements</li>
              <li className="nav__item" tabIndex="3" onClick={() => scrollTo('users')}>Users</li>
              <li className="nav__item" tabIndex="4" onClick={() => scrollTo('signUp')}>Sign Up</li>
            </ul>
          </nav>
